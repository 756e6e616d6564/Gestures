...
## La idea es evitar redundancias y bucles innecesarios, la prioridad máxima es mantener el        ##
## rendimiento estable, por ende, intentaré integrar el controlador de cursor junto al controlador ##
## de gestos.                                                                                      ##
